{
  "def": {
    ...
    "frame_hp": {
      ...
      "format": "{{py:thp_show?<img src='cfg://NDO/img/fragCorrelation/frame_hp.png' width='1020' height='32'>}}"
    },
    "score_bg": {
      "enabled": ${ "@settings.xc": "settings.battleLabels.total_hp_panel" },
      ...
      "shadow": { "enabled": false },
      "textFormat": { "align": "center" },
      "format": "{{py:thp_show?<img src='cfg://NDO/img/fragCorrelation/score_{{py:score_team_sign}}{{py:color_blind?_cb}}.png' width='380' height='32'>}}"
    },
    "score": {
      "enabled": ${ "@settings.xc": "settings.battleLabels.total_hp_panel" },
      "updateEvent": "PY(ON_SCORE_UPDATE)",
    ...
    "panel_hp_ally": {
      ...
      "textFormat": { "font": "NDO", "size": 18, "color": "0xFCFCFC", "align": "right", "leading": -19 },
    ...
    "panel_hp_enemy": {
      ...
      "antiAliasType": "advanced",
      "shadow": { "enabled": true, "distance": 1, "angle": 90, "color": "0x000000", "alpha": 80, "blur": 5, "strength": 1.5 },
      "textFormat": { "font": "NDO", "size": 18, "color": "0xFCFCFC", "align": "left", "leading": -19 },
