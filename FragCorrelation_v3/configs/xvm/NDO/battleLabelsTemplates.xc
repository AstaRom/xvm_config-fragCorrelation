{
  "def": {
    ...
    "frame_hp": {
      ...
      "format": "{{py:thp_show?<img src='cfg://NDO/img/fragCorrelation/frame_hp.png' width='376' height='36'>}}"
    },
    "score_bg": {
      "enabled": ${ "@settings.xc": "settings.battleLabels.total_hp_panel" },
    ...
    "current_hp": {
      ...
      "format": "{{py:thp_show?<textformat rightMargin='328'><b>{{py:current_hp(0)}}</b></textformat><br/><textformat leftMargin='328'><b>{{py:current_hp(1)}}</b></textformat>}}"
    },
    "high_caliber": {
      "enabled": ${ "@settings.xc": "settings.battleLabels.total_hp_panel" },
